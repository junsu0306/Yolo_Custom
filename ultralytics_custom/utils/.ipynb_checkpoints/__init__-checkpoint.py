...
OVERRIDES_CFG_PATH= ROOT / "cfg/my_cfg.yaml"
...
OVERRIDES_CFG_DICT = yaml_load(OVERRIDES_CFG_PATH)
for k, v in OVERRIDES_CFG_DICT.items():
    if isinstance(v, str) and v.lower() == "none":
        OVERRIDES_CFG_DICT[k] = None
OVERRIDES_CFG_KEYS = OVERRIDES_CFG_DICT.keys()
OVERRIDES_CFG = IterableSimpleNamespace(**OVERRIDES_CFG_DICT)
